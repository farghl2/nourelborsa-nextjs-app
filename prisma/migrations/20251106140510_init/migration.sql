...
CREATE TABLE "Subscription" (
    ...
    "endDate" TIMESTAMP(3),
    "renewedByAdmin" BOOLEAN NOT NULL DEFAULT false,
    "paymentId" TEXT,
...
CREATE TABLE "Stock" (
    ...
    "prohibitedRevenuePercentage" DOUBLE PRECISION,
    "interestBearingLoansPercentage" DOUBLE PRECISION,
    "interestBearingDepositsPercentage" DOUBLE PRECISION,
    "assetsPercentage" DOUBLE PRECISION,
    "totalAssets" DOUBLE PRECISION,
    "marketCapitalization" DOUBLE PRECISION,
    "recommendation" BOOLEAN NOT NULL DEFAULT false,
    "durationDays" INTEGER,
    "returnOnPrice" DOUBLE PRECISION,
    "fairValue" DOUBLE PRECISION,
    "earningsPerShare" DOUBLE PRECISION,
    "expectedFairValueNextYear" DOUBLE PRECISION,
    "expectedEarningsPerShare" DOUBLE PRECISION,
    "purificationPercentage" DOUBLE PRECISION,
...
-- AddForeignKey
ALTER TABLE "SubscriptionPlan" ADD CONSTRAINT "SubscriptionPlan_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
